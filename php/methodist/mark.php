	...
	if (isset($_POST[$m]))
{
	...
	{
		mysql_query("UPDATE  tblMark SET  txtReviewerMark = '$mark2',txtСommissionMark =  '$mark3',txtFinalMark =  '$mark4' WHERE intWorkId='".$topic["intWorkId"]."' and intStudentId='".safe_var($intStudentId)."'");
