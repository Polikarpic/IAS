...
session_start();
	...
	$count = mysql_fetch_array(mysql_query("select COUNT(*) as max from tblWork WHERE boolType='0' and intWorkStatus='1' and txtStudentId is not null"));
	...
	WHERE w.boolType='0' and w.intWorkStatus='1' and w.txtStudentId is not null ORDER BY w.intWorkId DESC LIMIT ".$row_start.", ".$row_limit."");	
...
?>
  		     ...
  		     <table class="tftable">
				...
				while($data = mysql_fetch_array($query))
				{
					...
					echo '<tr>';
					echo '<td>'.strftime('%G',strtotime($data["dateRentingWork"])).'</td>';
...
echo 'Страница: ';
	...
	{		
		...
		{
			echo '<a href="./../../list?page1='.$_GET['page1'].'&page2='.$_GET['page2'].'&page3='.$_GET['page3'].'&page4='.$p.'&page5='.$_GET['page5'].'&page6='.$_GET['page6'].'&page7='.$_GET['page7'].'&page8='.$_GET['page8'].'&c1='.$_GET['c1'].'&c2=2&c3='.$_GET['c3'].'&c4='.$_GET['c4'].'">'.$p.'</a> ';
		}
	}
}
?>	