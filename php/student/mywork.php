...
include_once("db.php");
	...
	$query = mysql_query("SELECT intWorkId, intTeacherId, boolType, txtTopic FROM tblWork WHERE intWorkStatus='0' and txtStudentId LIKE '%".$_SESSION['userId']."%' LIMIT 1");
...
<h1>Моя работа</h1>
<p>[<?php echo $typeWork; ?>] <a href="current_topic?z=<?php echo $data["intWorkId"]; ?>"><b><?php echo $data["txtTopic"]; ?></b></a></p>
<p>Руководитель: <a href="profile?z=<?php echo $data["intTeacherId"]; ?>"><b><?php echo  $teacher; ?></b></a></p>
